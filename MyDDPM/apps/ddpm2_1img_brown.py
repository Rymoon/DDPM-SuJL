...
# 基本配置
_imgs = list_pictures('/home/yumeng/workspace/Dataset/CelebAHQ_1/', 'jpg')
# repeat up to 10k
n = len(_imgs)
imgs = []
...
batch_size = 16  # 如果显存不够，可以降低为16，但不建议低于16 # 32 is too large for 24GB 3090
embedding_size = 128
