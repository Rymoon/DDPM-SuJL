...
# Modification version 1 parallel version 2
# 1. add tensorboard support
# 2. add version log folder support
# 
...
# 基本配置
imgs = list_pictures('/home/yumeng/workspace/DDPM-SuJL/Datasets/CelebAHQ/data256x256', 'png')
imgs += list_pictures('/home/yumeng/workspace/DDPM-SuJL/Datasets/CelebAHQ/data256x256_valid', 'png')
